...
spl_autoload_register( function ( $class_name ) {
	 ...
	 */
	if ( false === strpos( $class_name, 'Quick_Contact_Form' ) ) {
		return;
	}
	...
	if ( file_exists( $filepath ) ) {
		...
		wp_die( sprintf( __( 'The system file attempting to be loaded at %1$s does not exist.', 'quick-contact-form' ), esc_html( $filepath ) ) );
	}
} );
